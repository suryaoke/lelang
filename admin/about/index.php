                                 ...
                                 <tbody>
                                     <?php
                                        ...
                                        ?>
                                         ...
                                         <!-- BEGIN: Modal Update -->
                                         <div id="update-header-footer-modal-preview-<?php echo $data['id_about']; ?>" class="modal"
                                             tabindex="-1" aria-hidden="true">
                                             <div class="modal-dialog">
                                                 <div class="modal-content"> <!-- BEGIN: Modal Header -->
                                                     <div class="modal-header">
                                                         <h2 class="font-medium text-base mr-auto">Ubah Data About</h2>
                                                         ...
                                                         <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                             ...
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                 ...
                                                                 <input id="modal-form-1" type="text" name="visi" class="form-control"
                                                                     placeholder="Masukkan Visi" value="<?php echo $data['visi']; ?>" required>
                                                             </div>

                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
                                                                     class="form-label">Misi</label>
                                                                 <input id="modal-form-1" type="text" name="misi" class="form-control"
                                                                     placeholder="Masukkan Misi" value="<?php echo $data['misi']; ?>" required>
                                                             </div>
                                                             <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1"
